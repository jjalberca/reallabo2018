...
El procedimiento seguido es el explicado en la sección 3.2 del documento modelado de la asignatura. 
Se han promediado las P repeticiones en cada uno de los experimentos y con ello se obtienen los datos que el programa matlab utiliza para devolver los datos y las gráficas relevantes para el modelado del motor.
